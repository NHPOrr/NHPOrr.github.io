...
To tackle the prevalent problem of counterfeit we are developing physically unclonable markers made of 2D colloidal crystals (the image below contains several example crystals). Even though we follow the same synthesis steps each time, the pattern of grains that we create is different and unique. This is similar to how every snowflake has a different shape. <br><br>

Each colloidal crystal grain produces structural colour from the interaction of the micrometric lattice of colloidal beads and visible light. A patchwork of colours results that is visible with simple optics, like those found in a phone camera, allowing easy access to the unique grain structure. Through analysis of the structure and comparison to a database of known crystals, the authenticity and provenance of a linked product can be ensured.
</div>

<img src="Images/ENS-Chimie-29112024_Z087641.jpg" alt="ENS Chimie" style="max-width:100%; height:auto;">
...
<img src="Images/GrainBoundary.jpg" alt="Grain Boundary" style="max-width:100%; height:auto;">
...
<img src="Images/HomogeneousNucleaton.jpg" alt="Homogeneous Nucleation" style="max-width:100%; height:auto;">
